package info.whats_online.lohithinternship;
...
public class MainActivity extends Activity {
    ...
    {
        TextView t = (TextView) findViewById(R.id.likecount);
        ...
        switch(id){
            ...
            case R.id.save:
                    ...
                    if(fname.getText().toString().trim().equals("")){
                        Toast.makeText(getApplicationContext(),"edit text is empty, Enter something", Toast.LENGTH_LONG).show();
                    }  else{
                        addContact();
                    }
